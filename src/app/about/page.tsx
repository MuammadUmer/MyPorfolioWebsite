...
import { getCertifications, getEducation } from '@/lib/services/content';

const paragraphs = [
  "I'm Muhammad Umer, a Senior Full Stack Engineer based in Riyadh, Saudi Arabia, with 7+ years of experience designing and delivering scalable, high-performance web and mobile applications. I specialise in Node.js/NestJS/Express, Java/Spring Boot, and Python/Flask backends, cloud-native architectures on GCP, and cross-platform frontends with React.js and React Native.",
  "My background spans healthcare, real estate, logistics, AI, and blockchain — giving me the ability to quickly understand domain requirements and translate them into reliable, maintainable systems. Notable projects include Innova Care (offline-first home care on GCP), MyIndici (New Zealand's top-20 patient portal), Vivasta (community healthcare ecosystem for nurses and field staff), Bio Scan (AI-powered vital sign monitoring), Ask Cyphen (Kibana + ChatGPT threat analytics), and Eizhar (property management platform).",
